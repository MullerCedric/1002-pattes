...
add_action('init', 'mmp_remove_partner_fields');
function mmp_remove_partner_fields() {
	remove_post_type_support( 'partner', 'title' );
	remove_post_type_support( 'partner', 'editor' );
}

add_filter('acf/update_value/name=partner_name', 'mmp_acf_partner_title', 10, 3);
function mmp_acf_partner_title( $value, $post_id, $field ) {
	$new_title = $value;
