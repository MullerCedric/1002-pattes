...
add_action('init', 'maison1002pattes_register_partner');
function maison1002pattes_register_partner() {
...
add_action('init', 'maison1002pattes_remove_partner_fields');
function maison1002pattes_remove_partner_fields() {
