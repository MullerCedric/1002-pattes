...
add_action('init', 'maison1002pattes_register_question');
function maison1002pattes_register_question() {
...
add_action('init', 'maison1002pattes_remove_question_fields');
function maison1002pattes_remove_question_fields() {
